...
//		port(Light.class, "doON").accepts(SubLight.class, "switchON");
//		port(Light.class, "doOFF").accepts(SubLight.class, "switchOFF");
//		port(Light.class, "reqON").accepts(Monitor.class, "acceptON");
//		port(Light.class, "reqOFF").accepts(Monitor.class, "acceptOFF");
		
		
//		data(Light.class,"LightInfo").to(SubLight.class, "LightInfo");
//		data(SubLight.class, "isSwitchedOn").to(Light.class, "isSwitchedOn");
